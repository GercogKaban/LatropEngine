...
namespace SharedScene
{
    ...
    void createBluePortal(glm::vec3 origin, glm::quat rotation = glm::angleAxis(glm::radians(0.0f), glm::vec3(0, 0, 1)), glm::vec3 scale = { 1.6f, 0.3f, 2.8f }, bool isDecorated = false);
    void createOrangePortal(glm::vec3 origin, glm::quat rotation = glm::angleAxis(glm::radians(0.0f), glm::vec3(0, 0, 1)), glm::vec3 scale = { 1.6f, 0.3f, 2.8f }, bool isDecorated = false);
} // namespace SharedScene