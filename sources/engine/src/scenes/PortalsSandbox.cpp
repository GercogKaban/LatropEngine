...
void PortalsSandbox::createStablePlayground()
{
	...
	// MARK: Portals
	SharedScene::createBluePortal({ 4.0f, 1.5f, -5.0f }, glm::angleAxis(glm::radians(-45.0f), glm::vec3(0, 1, 0)));
	SharedScene::createOrangePortal({ -4.0f, 1.5f, -5.0f }, glm::angleAxis(glm::radians(45.0f), glm::vec3(0, 1, 0)));
}